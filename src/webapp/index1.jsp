    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="assets/dram.webp"  class="d-block img" alt="..." >
        </div>
        <div class="carousel-item">
          <img src="assets/odd.jpg" class="d-block img" alt="..." >
        </div>
        <div class="carousel-item">
          <img src="assets/cultur.jpg" class="d-block img" alt="..." >
        </div>
         <div class="carousel-item">
          <img src="assets/fashh.jpg" class="d-block img" alt="..." >
        </div>
      </div>
